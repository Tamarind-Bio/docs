...
IgDesign (https://app.tamarind.bio/tools/igdesign) is an in-vitro validated tool to redesign antibody CDRs in complex with antigens for improved binding affinity. It's developed by Absci and trained on the Structural Antibody Database (SAbDab) retrieved on December 6, 2022. 
